...
const App = () => {
  ...
  const handleVote = () => {
    const currentVotesArray = [...votes];
    currentVotesArray[selected] += 1;
    setVotes(currentVotesArray);
  }
  ...
  return (
    <div>
      ...
      <Anecdote anecdote={anecdotes} votes={votes} selected={selected}/>
